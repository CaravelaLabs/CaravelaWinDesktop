...
export const en: Translations = {
  ...
  boot: {
    ready: 'Caravela Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Caravela settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Hermes backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Caravela Desktop…'
    },
    errors: {
      backgroundExited: 'Caravela background process exited.',
      backgroundExitedDuringStartup: 'Caravela background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Caravela backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Caravela',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Caravela Desktop.',
    ...
    native: {
      ...
      inputBody: 'Caravela is waiting for your response.',
      turnDoneTitle: 'Caravela finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Caravela defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Caravela is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Caravela asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Caravela was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Caravela follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Caravela is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Caravela, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Caravela checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Caravela configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Caravela.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Caravela backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Caravela backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Caravela backend.',
      ...
      restartingMessage: 'Caravela Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Caravela ${version}` : ''}`,
      ...
      sshDesc:
        'Caravela is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Caravela path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Caravela found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Caravela runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Caravela is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Caravela path.',
      sshErrPlatform:
        'Unsupported remote platform. Caravela Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Caravela on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Caravela runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Caravela at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Caravela builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Caravela to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Caravela to generate pets.',
      backgroundHint: 'You can close this — Caravela will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Caravela desktop' },
    ...
    hermesActiveSessions: (version, count) => `Caravela ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Caravela environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Caravela will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Caravela backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Caravela. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Caravela...',
    placeholderReconnecting: 'Reconnecting to Caravela…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Caravela a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Caravela will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Caravela to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Caravela…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Caravela…',
    ...
    unsupportedMessage: 'This version of Caravela can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Caravela from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Caravela will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Caravela desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Caravela updater takes over in its own window and reopens Caravela automatically when it’s done. Please don’t reopen Caravela yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Caravela reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Caravela reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Caravela needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Caravela Desktop',
    setupChoiceDesc:
      'Connect this app to a Caravela gateway you already run, or install Caravela locally on this computer.',
    connectExistingTitle: 'Connect to existing Caravela',
    ...
    installLocalTitle: 'Install Caravela locally',
    installLocalDesc: 'Download Caravela, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Caravela Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Caravela',
    remoteSetupDesc: 'Enter your gateway URL. Caravela Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Caravela gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Caravela gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Caravela Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Caravela CLI or desktop instance is running. Stop any running Caravela instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Caravela Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Caravela is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Caravela…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Caravela',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Caravela at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Caravela connects automatically',
    ...
    authorizeThere: 'Authorize Caravela there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Caravela there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Caravela Desktop v${version}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Caravela will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Caravela is restarting...',
      askRestart: 'Ask Caravela to restart the server',
      lookingRestart: taskId => `Caravela is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Caravela is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Caravela to open a page.',
      finishedRestarting: message => `Caravela finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Caravela could not restart the server.',
      stillWorking:
        'Caravela is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Caravela is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Caravela gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Caravela won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Caravela needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Caravela needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Caravela Desktop to use Save Image.',
    restartToSaveImages: 'Restart Caravela Desktop to save images',
