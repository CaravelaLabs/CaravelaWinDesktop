...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Caravela Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Caravela backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Caravela inference gateway status',
      agents: 'Agents',
