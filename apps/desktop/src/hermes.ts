...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Caravela gateway connection closed',
      connectErrorMessage: 'Could not connect to Caravela gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Caravela gateway is not connected',
