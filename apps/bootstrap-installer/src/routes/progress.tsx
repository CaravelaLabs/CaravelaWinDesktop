...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Caravela' : 'Setting up Caravela'

  const description = isUpdate
    ? 'Caravela is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Caravela installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
